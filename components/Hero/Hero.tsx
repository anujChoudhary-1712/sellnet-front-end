...
export default function Hero() {
  return (
    <div className="flex flex-col gap-6 justify-center items-center px-6 h-[500px] w-full bg-[#7332bd]">
      <p className="text-white text-3xl sm:text-[35px] md:text-[42px] font-bold sm:w-[60%] text-center">
